...
//        JsonIterator.setMode(DecodingMode.DYNAMIC_MODE_AND_MATCH_FIELD_STRICTLY);
    ...
    public void test_int_list() throws IOException {
        ...
        List<Integer> val = iter.read(new TypeLiteral() {
        });
    ...
    public void test_string_list() throws IOException {
        ...
        List<String> val = iter.read(new TypeLiteral() {
        });
    ...
    public void test_string_set() throws IOException {
        ...
        Set<String> val = iter.read(new TypeLiteral() {
        });
    ...
    public void test_string_map() throws IOException {
        JsonIterator iter = JsonIterator.parse("{'hello': 'world'}".replace('\'', '"'));
        Map<String, String> val = iter.read(new TypeLiteral() {
        });
    ...
    public void test_integer_map() throws IOException {
        ...
        Map<String, Integer> val = iter.read(new TypeLiteral() {
        });
    ...
    public void test_list_of_list() throws Exception {
        ...
        List<List<Integer>> listOfList = iter.read(new TypeLiteral() {
        });
    ...
    public void test_generic_super_class() throws IOException {
        ...
        for (Binding field : desc.allDecoderBindings()) {
            fieldDecoderCacheKeys.put(field.getName(), field.getValueTypeLiteral().getDecoderCacheKey());
        }
        for (Binding field : ClassDescriptor.getEncodingClassDescriptor(new ClassInfo(Class3.class), true).getGetters()) {
            fieldDecoderCacheKeys.put(field.getName(), field.getValueTypeLiteral().getDecoderCacheKey());
        }
