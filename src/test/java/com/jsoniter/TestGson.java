...
public class TestGson extends TestCase {
    ...
    public void test_SerializedName() {
        ...
        obj = JsonIterator.deserialize(new GsonCompatibilityMode.ReBuilder().build(),
    ...
    public void test_Expose() {
        ...
        JsonIterator.deserialize(new GsonCompatibilityMode.ReBuilder().build(),
...
//            GsonCompatibilityMode config = new GsonCompatibilityMode.ReBuilder()
//                    .build();
...
//    }
    ...
    public void test_int_as_string() {
        ...
        GsonCompatibilityMode config = (GsonCompatibilityMode) new GsonCompatibilityMode.ReBuilder().build();
