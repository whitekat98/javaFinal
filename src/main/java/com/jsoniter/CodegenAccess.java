...
public class CodegenAccess {
    ...
    public static final boolean nextTokenIsComma(final JsonIterator iter) {
    ...
    private static boolean nextTokenIsCommaSlowPath(JsonIterator iter, byte c) {
        switch (c) {
            case ' ':
            case '\n':
            case '\r':
    ...
    public static byte nextToken(JsonIterator iter) {
    ...
    public static boolean readArrayStart(JsonIterator iter) {
    ...
    public static boolean readObjectStart(JsonIterator iter) {
        byte c = IterImpl.nextToken(iter);
        if (c == '{') {
            c = IterImpl.nextToken(iter);
            if (c == '}') {
    ...
    public static final String readObjectFieldAsString(JsonIterator iter) {
    ...
    static final boolean skipWhitespacesWithoutLoadMore(JsonIterator iter){
