...
public abstract class Any implements Iterable<Any> {
    ...
    protected static final Set<String> EMPTY_KEYS = Collections.unmodifiableSet(new HashSet<String>());
    protected static final EntryIterator EMPTY_ENTRIES_ITERATOR = new EntryIterator() {
        @Override
        public boolean next() {
            return false;
        }
    ...
    protected static final Iterator<Any> EMPTY_ITERATOR = new Iterator<Any>() {
        @Override
        public void remove() {
    ...
    public <T> T bindTo(TypeLiteral typeLiteral, T obj, Object... keys) {
    ...
    public <T> T as(TypeLiteral typeLiteral, Object... keys) {
    ...
    private static final int WILDCARDHASHCODE = Character.valueOf('*').hashCode();
