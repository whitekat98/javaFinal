...
public interface OmitValue {
	 ...
	 public final class CONSTANT {
	       ...
	       static final String CON = "0 == %s";
	       static final String CON1 = " == %s";
	   }
    ...
    class Parsed implements OmitValue {
        ...
        public static OmitValue parse(Type valueType, String defaultValueToOmit) {
            if ("void".equals(defaultValueToOmit)) {
                ...
                return new OmitValue.Parsed(defaultValue, defaultValueToOmit + CONSTANT.CON1);
            } else if (Boolean.class.equals(valueType)) {
                Boolean defaultValue = Boolean.valueOf(defaultValueToOmit);
            ...
            return par(valueType, defaultValueToOmit );
            
        }
        
        private static Parsed par(Type valueType, String defaultValueToOmit) {
