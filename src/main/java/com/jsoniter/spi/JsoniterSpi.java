...
public class JsoniterSpi {
    ...
    private static  Map<Object, String> configNames = new HashMap<Object, String>();
    private static  Map<String, Encoder> mapKeyEncoders = new HashMap<String, Encoder>();
    private static  Map<String, Decoder> mapKeyDecoders = new HashMap<String, Decoder>();
    private static  Map<String, Encoder> encoders = new HashMap<String, Encoder>();
    private static  Map<String, Decoder> decoders = new HashMap<String, Decoder>();
    private static  Map<Class, Extension> objectFactories = new HashMap<Class, Extension>();
    ...
    public static void registerPropertyDecoder(Class clazz, String property, Decoder decoder) {
        ...
        copyGlobalPropertyDecoder(clazz, property, decoder);
    }
    ...
    public static void registerPropertyDecoder(TypeLiteral typeLiteral, String property, Decoder decoder) {
        ...
        copyGlobalPropertyDecoder(typeLiteral.getType(), property, decoder);
    }
    ...
    public static void registerPropertyEncoder(Class clazz, String property, Encoder encoder) {
        ...
        copyGlobalPropertyEncoder(clazz, property, encoder);
    }
    ...
    public static void registerPropertyEncoder(TypeLiteral typeLiteral, String property, Encoder encoder) {
        ...
        copyGlobalPropertyEncoder(typeLiteral.getType(), property, encoder);
    }
    ...
    private static void copyGlobalSettings(String configName) {
        ...
        for (Map.Entry<TypeProperty, Decoder> entry : globalPropertyDecoders.entrySet()) {
            copyGlobalPropertyDecoder(entry.getKey().type, entry.getKey().property, entry.getValue());
        }
        for (Map.Entry<TypeProperty, Encoder> entry : globalPropertyEncoders.entrySet()) {
            copyGlobalPropertyEncoder(entry.getKey().type, entry.getKey().property, entry.getValue());

        }
    }

    private static void copyGlobalPropertyEncoder(Type type, String property, Encoder propertyEncoder) {
        addNewEncoder(property + "@" + TypeLiteral.create(type).getEncoderCacheKey(), propertyEncoder);
    }

    private static void copyGlobalPropertyDecoder(Type type, String property, Decoder propertyDecoder) {
