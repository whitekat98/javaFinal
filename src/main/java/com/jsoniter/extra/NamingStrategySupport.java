...
public class NamingStrategySupport {
        ...
        JsoniterSpi.registerExtension(new EmptyExtension() {
            ...
            public void updateClassDescriptor(ClassDescriptor desc) {
                for (Binding binding : desc.allBindings()) {
                    String translated = namingStrategy.translate(binding.getName());
    ...
    static NamingStrategy snakeCase = new NamingStrategy() {
        @Override
    ...
    static NamingStrategy upperCamelCase = new NamingStrategy() {
        @Override
        public String translate(String input) {
    ...
    static NamingStrategy lowerCase = new NamingStrategy() {
        @Override
        public String translate(String input) {
    ...
    static NamingStrategy kebabCase = new NamingStrategy() {
        @Override
        public String translate(String input) {
            if (input == null) return input; // garbage in, garbage out
            int length = input.length();
